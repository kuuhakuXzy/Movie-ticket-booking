...
export default function SeatDrawer({ selectedDate, onClose }: SeatDrawerProps) {
            ...
            <DrawerContent className="bg-zinc-900 border-0 text-white">
                <DrawerHeader className="ml-2">
                    <div className="flex justify-between items-center">
                        <div>
                            <DrawerTitle className="font-poppins pb-2">{selectedMovie?.title}</DrawerTitle>
                            <DrawerTitle className="font-poppins text-sm text-gray-400">
