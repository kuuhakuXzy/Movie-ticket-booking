...
//                 <input className="w-full border p-2 text-sm" name="price" value={newShowtime.price} onChange={handleInputChange} placeholder="Ticket Price" />
...
//                     <CardHeader>
//                         <CardTitle className="text-base font-semibold">Showtime for Movie ID: {showtime.movieId}</CardTitle>
//                     </CardHeader>
